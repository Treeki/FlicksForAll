...
@interface UIKeyboardLayoutStar : UIKeyboardLayout /*<UIKBEmojiHitTestResponder, UIKBResizingKeyplaneCoordinatorCoordinatorDelegate, UIKeyboardHandBiasTransitionCoordinatorDelegate, UIKeyboardPinchGestureRecognizerDelegate, UIKeyboardTypingStyleEstimatorDelegate>*/ {
    ...
    bool  _autoshift;
    /*UIKBBackgroundView **/ id _backgroundView;
    ...
    /*UIDelayedAction **/ id _delayedCentroidUpdate;
    SEL  _deleteAction;
    ...
    /*UIKeyboardEmojiKeyDisplayController **/ id _emojiKeyManager;
    ...
    /*UIGestureKeyboardIntroduction **/ id _gestureKeyboardIntroduction;
    bool  _ghostKeysEnabled;
    /*UIKeyboardHandBiasTransitionCoordinator **/ id _handBiasTransitionCoordinator;
    ...
    /*UIKBKeyViewAnimator **/ id _keyViewAnimator;
    UIKBTree * _keyboard;
    ...
    /*UIKBKeyplaneView **/ id _keyplaneView;
    ...
    /*UIDelayedAction **/ id _multitapAction;
    int  _multitapCount;
    UIKBTree * _multitapKey;
    bool  _muteNextKeyClickSound;
    /*UIKBRenderConfig **/ id _passcodeRenderConfig;
    UIImageView * _pathEffectGlowView;
    bool  _pendingDictationReload;
    /*UIKeyboardPinchGestureRecognizer **/ id _pinchGestureRecognizer;
    ...
    /*UIKBRenderConfig **/ id _renderConfig;
    /*UIKBResizingKeyplaneCoordinator **/ id _resizingKeyplaneCoordinator;
    SEL  _returnAction;
    ...
    id  _touchInfo;
    /*UIKeyboardSplitTransitionView **/ id _transitionView;
    /*_UIKeyboardTypingSpeedLogger **/ id _typingSpeedLogger;
...
// UIKeyboardLayoutStar (ContinuousPath)
...
// UIKeyboardLayoutStar (UIKeyboardLayoutJapanese50OnFlick)
...
- (CGImage *)cachedCompositeImageWithCacheKey:(id)arg1;
...
- (UIKeyboardTouchInfo *)infoForTouch:(UIKBTouchState *)arg1;
- (UIKeyboardTouchInfo *)infoForTouchUUID:(id)arg1;
...
- (bool)pointInside:(CGPoint)arg1 forEvent:(/*GSEvent **/id)arg2;
...
- (id)renderConfig;
- (CGImage *)renderedImageWithStateFallbacksForToken:(id)arg1;
- (CGImage *)renderedImageWithToken:(id)arg1;
- (CGImage *)renderedKeyplaneWithToken:(id)arg1 split:(bool)arg2;
